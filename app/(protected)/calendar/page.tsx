...
export default function CalendarPage() {
  ...
  const selectedDateEvents = selectedDateKey ? events[selectedDateKey] || [] : [];

  return (
    <div className="flex flex-col flex-1 overflow-hidden bg-background text-foreground relative">
      {/* Header */}
      <CalendarHeader
      ...
      <div className="flex-1 flex overflow-hidden relative">
        ...
        <div className="flex-1 flex flex-col relative overflow-hidden">
          ...
          {error && (
            <div className="p-4 bg-destructive/10 border-b border-destructive/20 flex items-center gap-3 text-destructive text-sm">
